...
export const Header = () => {
    /* Criando estado para hidden/show do menu mobile */
    const [hidden, setHidden] = useState(true);

    /* Criando estado para ativação do darkmode */
    ...
    /* Criando variáveis para acompanhar os navlinks.active */
                ...
                <div className="max-w-screen flex flex-wrap items-center justify-between mx-auto p-4">
                    ...
                    <div id='mobile-nav' className="flex md:order-2">
                        ...
                        <div className="relative hidden md:block">
                            ...
                            <input onChange={(e) => handleSearch(e.target.value)} type="text" id="search-navbar" className="block w-full p-2 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search..." autoComplete='off' />
                        </div>
                    ...
                    <div id='nav-link' className={`items-center justify-between ${hidden && 'hidden'} w-full md:flex md:w-auto md:order-1`}>
